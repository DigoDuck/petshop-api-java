...
const ProductManagementPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    preco: "",
    quantidade: "",
    // O backend espera o ID da categoria, não o objeto inteiro
    categoriaId: "",
  });
  ...
  const fetchCategorias = async () => {
    try {
      // Assumindo que sua API retorna todas as categorias sem paginação
  ...
  // --- LÓGICA DOS HANDLERS (AGORA FUNCIONAL) ---
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      handleCloseModal();
      fetchProdutos(); // Recarrega os dados para mostrar a atualização
    } catch (err) {
